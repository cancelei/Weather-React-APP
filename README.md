...
<div align="center">
  <h3><b>Real-Time Climate Data APP</b></h3>
...
# 📖 React Climate Data APP<a name="about-project"></a>
This is React project that includes multiple API calls per search. You can search a city and get the current Weather and 7-days forecast.
...
- Basic Layout
- React Html/CSS/JavaScript best paractices
- Using git flow and GitHub flow
...
- Implement testing
- Improve Homepage
- Improve the Styling of the search bar
...
I am grateful to Microverse collaborators for creating such an amazing environment where we can work and learn.
